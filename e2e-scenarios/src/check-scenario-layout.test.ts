...
describe("scenario layout command", () => {
  it("prints exhaustive per-platform acceptance accounting", () => {
    ...
    assert.match(
      result.stdout,
      /darwin: 16\/19 fully automated; mixed 1 \(AC-017\); expected skips 0; manual-native owners 2 \(AC-002, AC-015\); not-applicable 0\./,
    );
    assert.match(
      result.stdout,
      /linux: 16\/19 fully automated; mixed 1 \(AC-017\); expected skips 0; manual-native owners 1 \(AC-015\); not-applicable 1 \(AC-002\)\./,
    );
    assert.match(
      result.stdout,
      /win32: 11\/19 fully automated; mixed 1 \(AC-017\); expected skips 5 \(AC-003, AC-005, AC-013, AC-014, AC-016\); manual-native owners 2 \(AC-002, AC-015\); not-applicable 0\./,
    );
    assert.match(
      result.stdout,
      /16\/19 fully automated; 1\/19 mixed automated\/manual-native: AC-017/,
    );
    assert.match(
      result.stdout,
