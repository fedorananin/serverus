...
export const commands = {
	...
	transferPauseAll: () => typedError<null, ApiError>(__TAURI_INVOKE("transfer_pause_all")),
	transferResumeAll: () => typedError<null, ApiError>(__TAURI_INVOKE("transfer_resume_all")),
	transferCancelAll: () => typedError<null, ApiError>(__TAURI_INVOKE("transfer_cancel_all")),
	transferClearFinished: () => typedError<null, ApiError>(__TAURI_INVOKE("transfer_clear_finished")),
...
export const events = {
	...
	terminalDataEvent: makeEvent<TerminalDataEvent>("terminal-data-event"),
	terminalExitEvent: makeEvent<TerminalExitEvent>("terminal-exit-event"),
