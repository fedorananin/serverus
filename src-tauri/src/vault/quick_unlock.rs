...
//! reopened with Touch ID (SPEC §2.3).
//!
//! Platform-specific code stays behind [`QuickUnlock`] — future Linux/Windows
//! ports implement their own quick-unlock without touching the vault core.
